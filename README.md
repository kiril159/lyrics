...
Whisper models were trained to predict approximatipip3 install onnxruntime torchaudio
ve timestamps on speech segments (most of the times with 1 sec accuracy),
